...
permalink: "/blog/my-entire-front-end-development-process-from-start-to-finish/"
tags:
- process
- technology
- tools
...
A while back my good friend (and excellent designer) [Paul Bamford](https://twitter.com/the_pgb) introduced me to [Alfred](https://www.alfredapp.com). It has become a cornerstone of my work flow. [Alfred](https://www.alfredapp.com) allows you to set-up a shortcut key and just type the name of the "thing" you want to do and hit enter. It's effortless and amazing.

Need to launch an application?

Hit the short-cut: <code>Alt + Space</code>
...
Preferring to spend down time when travelling doing something productive, (on a crowded train, sometimes it's not practical to get the laptop out and start blogging) I like to use writing software that is not device dependent and can always access my content. Given that I use [Jekyll](https://jekyllrb.com) for the blog, the ability to write &amp; save the text in [Markdown](https://daringfireball.net/projects/markdown/) is a big plus. To that end [IA Writer](https://ia.net/writer) is usually my tool of choice. In actual fact, I do the initial write-up and first pass to every blog post in [IA Writer](https://ia.net/writer). Once it is complete, I move the post in to [Sublime Text](https://www.sublimetext.com), switch to Full Screen Distraction Mode <code>Alt + Cntrl + Shift + F</code>
...
I am a big fan of [Slicy](https://macrabbit.com/slicy/) and it slots in to my work flow perfectly, however more recently instead of using Slicy I have been using Photoshop asset generation tools. The tools are pretty similar to Slicy, in that they do automatic image exporting based on layer naming. Slicy can still come in handy however when you want to use its image mapping feature, so it still gets used pretty regularly.
...
Finally, creating the <abbr title="Hyper Text Markup Language">HTML</abbr>, <abbr title="Cascading Style Sheets">CSS</abbr> and JavaScript. Hand coding is essential, for production ready professional code and the best tool to create that is [Sublime Text](https://www.sublimetext.com). It's hands down the fastest and most feature rich tool to code in and has a huge variety of configurable options. [I wrote about my Sublime Text set-up here](https://vincentp.me/blog/sublime-text-setup).

As with most web professionals, I use [GitHub](https://github.com) to store and manage my code with the [GitHub client for OSX](https://mac.github.com). I don't mind using the terminal, but I'm not a masochist, I'd rather click the sync button than spend a few minutes remembering and typing in terminal commands if I don't have to.
...
Once the code is complete, I run it through the [W3C Validators](https://validator.w3.org) as a final sanity check and amend anything that may not be correct.
...
- [Pinboard](https://pinboard.in) with [Shiori](https://aki-null.net/shiori/)
- [Feedly](https://cloud.feedly.com)
- [Moleskin](https://www.moleskine.com/gb/collections/model/product/squared-soft-notebook-extra-large)
- [Bullet Journal System](https://www.bulletjournal.com)
- [Wunderlist](https://www.wunderlist.com/en/)

## Coding Tools

-  [GitHub](https://github.com)
-  [GitHub client for OSX](https://mac.github.com)
-  [Sublime Text](https://www.sublimetext.com). Also see [my Sublime set-up](https://vincentp.me/blog/sublime-text-setup)
-  [CodeKit](https://incident57.com/codekit/)
-  [HTML Inspector](https://github.com/philipwalton/html-inspector)
-  [ProCSSor](https://procssorapp.com)
...
-  [Adobe Creative Cloud](https://www.adobe.com/uk/products/creativecloud)

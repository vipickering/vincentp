...
timezone: "GMT"
date: "2013-11-20T00:00:01Z"
meta:  A process to work quickly and easily with Jekyll.
summary:  Trying to work better with Jekyll
permalink: "/blog/a-smarter-jekyll-workflow/"
tags:
- jekyll
---

I selected [Jekyll](https://jekyllrb.com) as the platform for my blog after trying out many other options. It’s a great blogging platform, and its balancing between code flexibility and simple blogging software really hits my sweet spot.

One of the major selling points with Jekyll, is the tight integration with [GitHub Pages](https://pages.github.com). The easy deployment and removal of dealing with terrible hosting companies, FTP servers and all the usual deployment issues are a huge boon, especially when most people blog in their spare time. The last thing you want to deal with at 1AM is a server that has exceeded its bandwidth and gone down.

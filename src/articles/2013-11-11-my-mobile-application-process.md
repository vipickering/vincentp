...
permalink: "/blog/my-entire-mobile-application-process/"
tags:
- process
- technology
- html
...
My daily phone of choice is an [iPhone](https://www.apple.com/iphone), but while this has won out in the feature set for me, I try to remain open minded:
...
In my opinion, there still is a gap in the market for a great designer version of [GitHub](https://www.github.com). It always makes me nervous when designing that I may loose something I really want to revert or keep later. I have tried [Adobe Creative Cloud](https://www.adobe.com/uk/creativecloud.html), which is basically [Dropbox](https://www.dropbox.com), with more storage as standard, but goes down constantly and is pretty unreliable. [Layervault](https://www.layervault.com) was a better alternative, but I also ran in to issues with content not being saved properly and a lot of slowdown every time my computer loaded.
...
-  [Instashare](https://instashareapp.com)
-  [Sketch](https://www.bohemiancoding.com/sketch/)
-  [Adobe Creative Cloud](https://www.adobe.com/uk/products/creativecloud.html)
-  [Keynote](https://www.apple.com/uk/keynote/) with [Blueprint](https://github.com/vipickering/Blueprint)

...
permalink: "/blog/meaningful-debate/"
tags:
- thoughts
- technology
- meetups
...
Recently I read the article [Reinventing The Tech Conference Experience](https://coding.smashingmagazine.com/2013/11/20/reinventing-the-tech-conference-experience/) on Smashing Magazine, and it felt like a classic case of mis-diagnosing a problem.
...
There has been a great deal of research done on the conversation model, in particular Dr Paul Pangaro has done a [large amount of work](https://vimeo.com/43677920)in this area, de-constructing the effective conversation model in to it’s constituent components so that we can understand and write software to have meaningful conversation.
